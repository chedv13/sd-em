...
// This entry need to be wrapped in an IIFE because it declares 'SD' on top-level, which conflicts with the current library output.
(() => {
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
...
class SD {
    constructor(connectionID) {
        this.validateConnectionID = () => __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch(`${SD.apiUrl}/connections/validate`, {
                    headers: {
    ...
    attachDrawingModal(cssSelector, shopDrawingID) {
    ...
    openDrawingModal(shopDrawingID) {
        const modalEl = document.createElement('div');
        modalEl.className = 'sde__modal';
        modalEl.innerHTML = `<div style="display:flex;flex-direction:row;justify-content:space-between;padding:16px"><div style="font-size:16px;font-weight:700"></div><div style="cursor:pointer;height:16px;width:16px" onclick="this.closest(&quot;.sde__modal&quot;).remove()"><svg viewBox="0 0 298.667 298.667" style="enable-background:new 0 0 298.667 298.667" xml:space="preserve"><g><g><polygon points="298.667,30.187 268.48,0 149.333,119.147 30.187,0 0,30.187 119.147,149.333 0,268.48 30.187,298.667 149.333,179.52 268.48,298.667 298.667,268.48 179.52,149.333" fill="#222222"/></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg></div></div><div style="display:flex;flex:1 1 auto;justify-content:center">${this.buildModalBody(shopDrawingID)}</div>`;
